var sayings = [
	...
	["dd is horrible on purpose. It's a joke about OSg360 JCL. But today it's an internationally standardized joke. I guess that says it all.", '', '- Rob Pike'],
...
function chooseSaying() {
	 return sayings[Math.floor(Math.random()*sayings.length)];
}

function say(saying) {
	saying.forEach(function(item) {
		console.log(item);
	});
}
